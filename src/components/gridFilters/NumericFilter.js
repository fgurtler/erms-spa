...
class NumericFilter extends React.Component {
  ...
  render() {
    ...
    let tooltipText = 'Input Methods: \r\n  * Range (x-y) \r\n  * Greater Then (>x) \r\n  * Less Then (<y)';

    return (
      <div>
        <div style={columnStyle} className="ui mini input">
          <input key={inputKey} type="text" placeholder="e.g. 3,10-15,>20" onChange={this.handleChange} onKeyPress={this.handleKeyPress}/>
        </div>
        <div className="input-sm" style={badgeStyle}>
